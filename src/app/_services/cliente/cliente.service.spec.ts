...
describe('ClienteService', () => {
  ...
  beforeEach(() => {
    ...
    spyOn(localStorage, 'getItem').and.callFake((key: string) => {
      if (key === 'id_empresa') return mockEmpresa;
  ...
  it('debería obtener todos los clientes', () => {
    ...
    const req = httpMock.expectOne(`${environment.API_URL}/psclientes/${mockEmpresa}`);
  ...
  it('debería obtener clientes', () => {
    ...
    const req = httpMock.expectOne(`${environment.API_URL}/listadoclientes/${mockEmpresa}`);
  ...
  it('debería subir archivo', () => {
    ...
    const req = httpMock.expectOne(`${environment.API_URL}/guardarArchivoAdjunto`);
    expect(req.request.method).toBe('POST');
    expect(req.request.body.id_empresa).toEqual(mockEmpresa);
  ...
  it('debería editar archivo', () => {
    ...
    const req = httpMock.expectOne(`${environment.API_URL}/editarArchivoAdjunto`);
    expect(req.request.method).toBe('PUT');
    expect(req.request.body.id_empresa).toEqual(mockEmpresa);
    expect(req.request.body.id_usuario).toEqual(mockId);
    req.flush({ ok: true });
